        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "data": {
                        "type": "object",
                        "description": "The data for the new record (e.g., {\"Name\": \"New Account\", \"Industry\": \"Technology\"})",
                        # Schema simplified to work around potential MCP parser issues
                    },
                },
        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "data": {
                        "type": "object",
                        "description": "The updated data for the record (e.g., {\"BillingCity\": \"San Francisco\"})",
                        # Schema simplified
                    },
                },
